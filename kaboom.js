export function big() {
  ...
  let isBig = false;
  let JUMP_FORCE = 300;
  let BIG_JUMP_FORCE = JUMP_FORCE + 100;
...
var Nt = (i, t, l) =>
    t in i
      ? ir(i, t, { enumerable: !0, configurable: !0, writable: !0, value: l })
      : (i[t] = l),
  P = (i, t) => {
  ...
  D = (i, t) => Hi(i, zi(t));
var a = (i, t) => ir(i, "name", { value: t, configurable: !0 });
...
function B(i, t) {
  ar.has(i) ||
    (ar.add(i), console.warn(`${i} is deprecated. Use ${t} instead.`));
}
a(B, "deprecateMsg");
var T = a(
  (i, t, l) =>
...
var N = class {
    ...
    dist(...t) {
      let l = f(...t);
      return Math.sqrt(
        (this.x - l.x) * (this.x - l.x) + (this.y - l.y) * (this.y - l.y)
      );
    }
    len() {
...
a(v, "Color"),
  ...
  b(v, "GREEN", E(0, 255, 0)),
  b(v, "BLUE", E(0, 0, 255)),
  b(v, "YELLOW", E(255, 255, 0)),
  b(v, "MAGENTA", E(255, 0, 255)),
  b(v, "CYAN", E(0, 255, 255)),
  b(v, "WHITE", E(255, 255, 255)),
  b(v, "BLACK", E(0, 0, 0));
function E(...i) {
...
var R = class {
  ...
  mult(t) {
    ...
    for (let w = 0; w < 4; w++)
      for (let U = 0; U < 4; U++)
        l[w * 4 + U] =
          this.m[0 * 4 + U] * t.m[w * 4 + 0] +
          this.m[1 * 4 + U] * t.m[w * 4 + 1] +
          this.m[2 * 4 + U] * t.m[w * 4 + 2] +
          this.m[3 * 4 + U] * t.m[w * 4 + 3];
    return new R(l);
  }
  multVec4(t) {
    return {
      ...
      z:
        t.x * this.m[2] + t.y * this.m[6] + t.z * this.m[10] + t.w * this.m[14],
      w:
        t.x * this.m[3] + t.y * this.m[7] + t.z * this.m[11] + t.w * this.m[15],
    };
  }
  multVec3(t) {
  ...
  multVec2(t) {
    return f(
      t.x * this.m[0] + t.y * this.m[4] + 0 * this.m[8] + 1 * this.m[12],
      t.x * this.m[1] + t.y * this.m[5] + 0 * this.m[9] + 1 * this.m[13]
    );
  }
  static translate(t) {
  ...
  invert() {
    ...
    (t[0] = this.m[5] * l - this.m[6] * w + this.m[7] * U),
      (t[4] = -(this.m[4] * l - this.m[6] * p + this.m[7] * S)),
      (t[8] = this.m[4] * w - this.m[5] * p + this.m[7] * A),
      (t[12] = -(this.m[4] * U - this.m[5] * S + this.m[6] * A)),
      (t[1] = -(this.m[1] * l - this.m[2] * w + this.m[3] * U)),
      (t[5] = this.m[0] * l - this.m[2] * p + this.m[3] * S),
      (t[9] = -(this.m[0] * w - this.m[1] * p + this.m[3] * A)),
      (t[13] = this.m[0] * U - this.m[1] * S + this.m[2] * A),
      (t[2] = this.m[1] * q - this.m[2] * V + this.m[3] * j),
      (t[6] = -(this.m[0] * q - this.m[2] * X + this.m[3] * Y)),
      (t[10] = this.m[0] * an - this.m[1] * X + this.m[3] * xt),
      (t[14] = -(this.m[0] * j - this.m[1] * Y + this.m[2] * xt)),
      (t[3] = -(this.m[1] * vt - this.m[2] * ve + this.m[3] * Ee)),
      (t[7] = this.m[0] * vt - this.m[2] * Te + this.m[3] * J),
      (t[11] = -(this.m[0] * ve - this.m[1] * Te + this.m[3] * $e)),
      (t[15] = this.m[0] * Ee - this.m[1] * J + this.m[2] * $e);
    let Et =
      this.m[0] * t[0] +
      this.m[1] * t[4] +
      this.m[2] * t[8] +
    ...
    for (let Se = 0; Se < 4; Se++)
      for (let Ce = 0; Ce < 4; Ce++) t[Se * 4 + Ce] *= 1 / Et;
    return new R(t);
  }
  toString() {
    ...
    gen(...t) {
      ...
      if (t.length === 1) {
        ...
        if (t[0] instanceof v && t[1] instanceof v)
          return E(
            this.gen(t[0].r, t[1].r),
            this.gen(t[0].g, t[1].g),
            this.gen(t[0].b, t[1].b)
          );
      }
    }
  };
...
function yr(i, t) {
  return (
    i.p2.x >= t.p1.x && i.p1.x <= t.p2.x && i.p2.y >= t.p1.y && i.p1.y <= t.p2.y
  );
}
a(yr, "testRectRect2");
function zt(i, t) {
...
function Jt(i, t) {
  if (
    ...
    return null;
  let l =
    (t.p2.y - t.p1.y) * (i.p2.x - i.p1.x) -
    (t.p2.x - t.p1.x) * (i.p2.y - i.p1.y);
  if (l === 0) return null;
  let w =
      ((t.p2.x - t.p1.x) * (i.p1.y - t.p1.y) -
        (t.p2.y - t.p1.y) * (i.p1.x - t.p1.x)) /
      l,
    U =
      ((i.p2.x - i.p1.x) * (i.p1.y - t.p1.y) -
        (i.p2.y - i.p1.y) * (i.p1.x - t.p1.x)) /
      l;
...
function ce(i, t) {
  let l = Jt(i, t);
  return l
    ? f(i.p1.x + l * (i.p2.x - i.p1.x), i.p1.y + l * (i.p2.y - i.p1.y))
    : null;
}
a(ce, "testLineLine");
function ft(i, t) {
  return ae(i, t.p1) || ae(i, t.p2)
    ? !0
    : !!ce(t, new le(i.p1, f(i.p2.x, i.p1.y))) ||
        !!ce(t, new le(f(i.p2.x, i.p1.y), i.p2)) ||
        !!ce(t, new le(i.p2, f(i.p1.x, i.p2.y))) ||
        !!ce(t, new le(f(i.p1.x, i.p2.y), i.p1));
}
a(ft, "testRectLine");
function ae(i, t) {
...
function xe(i, t) {
  ...
  for (let w = 0, U = i.length - 1; w < i.length; U = w++)
    i[w].y > t.y != i[U].y > t.y &&
      t.x < ((i[U].x - i[w].x) * (t.y - i[w].y)) / (i[U].y - i[w].y) + i[w].x &&
      (l = !l);
  return l;
}
  ...
  tick(t) {
    this.buf.push(1 / t),
      ...
      this.timer >= 1 &&
        ((this.timer = 0),
        (this.fps = Math.round(
          this.buf.reduce((l, w) => l + w) / this.buf.length
        )),
        (this.buf = []));
  }
};
...
var no = a((i = {}) => {
  let t = (() => {
    ...
    l = (() => {
      ...
      e.bindBuffer(e.ARRAY_BUFFER, c),
        e.vertexAttribPointer(0, 3, e.FLOAT, !1, je * 4, 0),
        e.enableVertexAttribArray(0),
        e.vertexAttribPointer(1, 2, e.FLOAT, !1, je * 4, 12),
        e.enableVertexAttribArray(1),
        e.vertexAttribPointer(2, 4, e.FLOAT, !1, je * 4, 20),
        e.enableVertexAttribArray(2),
        e.bufferData(e.ARRAY_BUFFER, bt * 4, e.DYNAMIC_DRAW),
        e.bindBuffer(e.ARRAY_BUFFER, null);
      let s = e.createBuffer();
      e.bindBuffer(e.ELEMENT_ARRAY_BUFFER, s),
        e.bufferData(e.ELEMENT_ARRAY_BUFFER, bt * 2, e.DYNAMIC_DRAW),
  ...
  let w = (() => {
    ...
    p = {
      ...
      on(e, n) {
        return (
          this.events[e] || (this.events[e] = new $()), this.events[e].pushd(n)
        );
      },
      trigger(e, ...n) {
      ...
      scenes: {},
      logs: [],
      cam: { pos: ot(), scale: f(1), angle: 0, shake: 0, transform: new R() },
    };
  function S(e) {
    return (
      U.numLoading++,
  ...
  function j(e) {
    let n = new Image();
    return (
      (n.src = cr(e) ? e : U.urlPrefix + e),
      (n.crossOrigin = "anonymous"),
      new Promise((r, u) => {
        (n.onload = () => r(n)),
          (n.onerror = () => u(`Failed to load image from "${e}"`));
      })
    );
  }
  a(j, "loadImg");
  ...
  function ve(e = 1, n = 1, r = 0, u = 0, c = 1, s = 1) {
    let o = [],
      ...
      h = s / n;
    for (let m = 0; m < n; m++)
      for (let g = 0; g < e; g++) o.push(new k(r + g * d, u + m * h, d, h));
    return o;
  }
  a(ve, "slice");
  function Ee(e, n) {
  ...
  function Te(e, n, r = {}) {
    let u = Ke(n, r),
      ...
      s = { tex: u, frames: c, anims: r.anims || {} };
      ...
      new Promise((r, u) => {
        ...
        typeof n == "string" &&
          V(n)
            ...
            .then((c) => new Promise((s, o) => w.ctx.decodeAudioData(c, s, o)))
            .then((c) => {
              let s = { buf: c };
              e && (U.sounds[e] = s), r(s);
            })
  ...
  function Br(e) {
    return (
      e !== void 0 && (w.masterNode.gain.value = z(e, Or, Ir)),
      w.masterNode.gain.value
    );
  }
  a(Br, "volume");
  function Xe(e, n = { loop: !1, volume: 1, speed: 1, detune: 0, seek: 0 }) {
    var g;
    if (typeof e == "string") {
      let y = Xe({ buf: Gr() });
      return (
      ...
      m = {
        ...
        play(y) {
          ...
          (c = r.createBufferSource()),
            (c.buffer = x.buffer),
            (c.loop = x.loop),
            (c.playbackRate.value = x.playbackRate.value),
            c.detune && (c.detune.value = x.detune.value),
            c.connect(s);
        ...
        speed(y) {
          return (
            y !== void 0 && (c.playbackRate.value = z(y, ds, fs)),
            c.playbackRate.value
          );
        },
        detune(y) {
          return c.detune
            ? (y !== void 0 && (c.detune.value = z(y, ps, ms)), c.detune.value)
            : 0;
        },
        volume(y) {
  ...
  function Ke(e, n = {}) {
    ...
    return (
      r.texParameteri(r.TEXTURE_2D, r.TEXTURE_MIN_FILTER, c),
      r.texParameteri(r.TEXTURE_2D, r.TEXTURE_MAG_FILTER, c),
      r.texParameteri(r.TEXTURE_2D, r.TEXTURE_WRAP_S, s),
      r.texParameteri(r.TEXTURE_2D, r.TEXTURE_WRAP_T, s),
  ...
  function cn(e = sn, n = on) {
    ...
    if (
      (r.attachShader(h, o),
      r.attachShader(h, d),
      r.bindAttribLocation(h, 0, "a_pos"),
      r.bindAttribLocation(h, 1, "a_uv"),
      r.bindAttribLocation(h, 2, "a_color"),
      r.linkProgram(h),
      (u = r.getProgramInfoLog(h)) &&
        u !==
          `
`)
    )
      ...
      send(m) {
        ...
        for (let g in m) {
          ...
          typeof y == "number"
            ? r.uniform1f(x, y)
            : y instanceof R
            ? r.uniformMatrix4fv(x, !1, new Float32Array(y.m))
            : y instanceof v
            ? r.uniform4f(x, y.r, y.g, y.b, y.a)
            : y instanceof Fe
            ? r.uniform3f(x, y.x, y.y, y.z)
            : y instanceof L && r.uniform2f(x, y.x, y.y);
        }
        this.unbind();
      },
    };
  ...
  function Tt(e, n, r, u = l.defTex, c = l.defShader, s = {}) {
    (u = u != null ? u : l.defTex),
      (c = c != null ? c : l.defShader),
      (u !== l.curTex ||
        c !== l.curShader ||
        !jt(l.curUniform, s) ||
        l.vqueue.length + e.length * je > bt ||
        l.iqueue.length + n.length > bt) &&
        ln();
    for (let o of e) {
  ...
  function ln() {
    if (
      ...
      return;
    let e = t.gl;
    l.curShader.send(l.curUniform),
      e.bindBuffer(e.ARRAY_BUFFER, l.vbuf),
      e.bufferSubData(e.ARRAY_BUFFER, 0, new Float32Array(l.vqueue)),
      e.bindBuffer(e.ELEMENT_ARRAY_BUFFER, l.ibuf),
      e.bufferSubData(e.ELEMENT_ARRAY_BUFFER, 0, new Uint16Array(l.iqueue)),
      l.curShader.bind(),
      l.curTex.bind(),
      e.drawElements(e.TRIANGLES, l.iqueue.length, e.UNSIGNED_SHORT, 0),
      l.curTex.unbind(),
      l.curShader.unbind(),
      e.bindBuffer(e.ARRAY_BUFFER, null),
      e.bindBuffer(e.ELEMENT_ARRAY_BUFFER, null),
  ...
  function pe(e) {
    ...
    let n = e.width,
      r = e.height,
      c = Ye(e.origin || Ne).scale(f(n, r).scale(-0.5)),
  ...
  function Yr(e) {
    ...
    if (e.tiled) {
      ...
      e.width && e.height
        ? ((c.x = e.width / r), (c.y = e.height / u))
        : e.width
        ? ((c.x = e.width / r), (c.y = c.x))
        : e.height && ((c.y = e.height / u), (c.x = c.y)),
        pe(
          D(P({}, e), {
            scale: c.scale(e.scale || f(1)),
            tex: e.tex,
  ...
  function hn(e) {
    ...
    if (!n)
      if (typeof e.sprite == "string") {
        St.has(e.sprite) ||
          (St.add(e.sprite),
          J(e.sprite, e.sprite).then((s) => St.delete(e.sprite)));
        return;
  ...
  function Q(e) {
    ...
    if (e.radius) {
      ...
      s = [
        f(o, 0),
        f(n - o, 0),
        ...Re(f(n - o, o), o, o, 270, 360),
        f(n, o),
        f(n, r - o),
        ...Re(f(n - o, r - o), o, o, 0, 90),
        f(n - o, r),
        f(o, r),
        ...Re(f(o, r - o), o, o, 90, 180),
        f(0, r - o),
        f(0, o),
        ...Re(f(o, o), o, o, 180, 270),
      ];
    }
  ...
  function Ct(e) {
    ...
    e.radius !== 0 &&
      pn(D(P({}, e), { radiusX: e.radius, radiusY: e.radius, angle: 0 }));
  }
  a(Ct, "drawCircle");
  function pn(e) {
    var n, r;
  ...
  function Qe(e) {
    ...
    if (!(n < 3)) {
      if (
        (re(), I(e.pos), ne(e.scale), Je(e.angle), I(e.offset), e.fill !== !1)
      ) {
  ...
  function mn(e, n) {
    n.pos && (e.pos = e.pos.add(n.pos)),
      n.scale && (e.scale = e.scale.scale(f(n.scale))),
  ...
  function me(e) {
    ...
    let { charStyleMap: r, text: u } = $r(e.text + ""),
      c = u.split(""),
      s = n.qw * n.tex.width,
      o = n.qh * n.tex.height,
      d = e.size || o,
    ...
    for (; te < c.length; ) {
      ...
      `
`
        ? ((x += g), (y = 0), (ee = null), M.push(oe), O.push(M), (M = []))
        : (e.width ? y + m > e.width : !1) &&
          ((x += g),
          (y = 0),
          ee != null &&
            ((te -= M.length - ee), (oe = c[te]), (M = M.slice(0, ee))),
          (ee = null),
          O.push(M),
          (M = [])),
        oe !==
          `
` && (M.push(oe), (y += m), oe === " " && (ee = M.length)),
        (W = Math.max(W, y)),
        te++;
    }
    ...
    let Ae = [],
      Oe = f(e.pos || 0),
      _ = Ye(e.origin || Ne).scale(0.5),
      se = -_.x * m - (_.x + 0.5) * (W - m),
      Ie = -_.y * g - (_.y + 0.5) * (x - g),
      ut = 0;
    return (
      O.forEach((oe, Bi) => {
  ...
  function Un() {
    ...
    if (i.letterbox) {
      ...
      if (s > o) {
        ...
        e.scissor(m, 0, d, h),
          e.viewport(m, 0, d, r),
          (l.viewport = { x: m, y: 0, width: d, height: r });
      } else {
        ...
        e.scissor(0, m, d, h),
          e.viewport(0, m, n, h),
          (l.viewport = { x: 0, y: m, width: n, height: h });
      }
      return;
    }
    if (i.stretch) {
      ...
      e.viewport(0, 0, n, r),
        (l.viewport = { x: 0, y: 0, width: n, height: r });
      return;
    }
    (l.width = n / t.scale),
      (l.height = r / t.scale),
  ...
  a(G, "height"),
    t.canvas.addEventListener("mousemove", (e) => {
      (t.mousePos = f(
        ((e.offsetX - l.viewport.x) * F()) / l.viewport.width,
        ((e.offsetY - l.viewport.y) * G()) / l.viewport.height
      )),
        (t.mouseDeltaPos = f(e.movementX, e.movementY).scale(1 / t.scale)),
        (t.isMouseMoved = !0);
    }),
    ...
    t.canvas.addEventListener("keydown", (e) => {
      ...
      ls.includes(n) && e.preventDefault(),
        n.length === 1 && t.charInputted.push(e.key),
        n === "space" && t.charInputted.push(" "),
        e.repeat
          ? ((t.isKeyPressedRepeat = !0), (t.keyStates[n] = "rpressed"))
          : ((t.isKeyPressed = !0), (t.keyStates[n] = "pressed"));
    }),
    ...
    t.canvas.addEventListener("touchstart", (e) => {
      ...
      e.preventDefault();
      let n = e.touches[0];
      (t.mousePos = f(n.clientX, n.clientY).scale(1 / t.scale)),
        (t.mouseStates.left = "pressed");
    }),
    ...
    t.canvas.addEventListener("touchstart", (e) => {
      [...e.changedTouches].forEach((n) => {
        p.trigger(
          "onTouchStart",
          n.identifier,
          f(n.clientX, n.clientY).scale(1 / t.scale)
        );
      });
    }),
    t.canvas.addEventListener("touchmove", (e) => {
  ...
  function Wt(e) {
    return e === void 0
      ? t.isKeyPressedRepeat
      : t.keyStates[e] === "pressed" || t.keyStates[e] === "rpressed";
  }
  a(Wt, "isKeyPressedRepeat");
  function Mt(e) {
    return (
      t.keyStates[e] === "pressed" ||
      t.keyStates[e] === "rpressed" ||
      t.keyStates[e] === "down"
    );
  }
  a(Mt, "isKeyDown");
  ...
  function En(e) {
    let n = new Map(),
      ...
      c = {
        ...
        update() {
          this.paused ||
            (this.revery((s) => s.update()), this.trigger("update"));
        },
        draw() {
          this.hidden ||
            (re(),
        ...
        use(s) {
          ...
          this.exists()
            ? (s.add && s.add.call(this),
              s.load && Ue(() => s.load.call(this)),
              d())
            : s.require && o.cleanups.push(this.on("add", d));
        },
        unuse(s) {
          if (n.has(s)) {
            let o = n.get(s);
        ...
        get(s) {
          return this.children
            ...
            .sort((o, d) => {
              var g, y, x, W, O, M;
              let h =
                  (y = p.layers[(g = o.layer) != null ? g : p.defLayer]) != null
                    ? y
                    : 0,
                m =
                  (W = p.layers[(x = d.layer) != null ? x : p.defLayer]) != null
                    ? W
                    : 0;
              return h == m
                ? ((O = o.z) != null ? O : 0) - ((M = d.z) != null ? M : 0)
                : h - m;
            });
        },
        every(s, o) {
  ...
  function qe(e, n, r) {
    return (
      p.objEvents[e] || (p.objEvents[e] = new $()),
      p.objEvents[e].pushd({ tag: n, cb: r })
    );
  }
  a(qe, "on");
  function Pe(e, n) {
  ...
  function In() {
    H("f1", () => {
      ...
      H("f6", () => {
        C.curRecording
          ? (C.curRecording.download(), (C.curRecording = null))
          : (C.curRecording = Nn());
      });
  }
  a(In, "enterDebugMode");
  ...
  function it(...e) {
    return {
      ...
      moveBy(...n) {
        ...
        if (
          this.solid &&
          ((o = this.area) == null ? void 0 : o.shape) === "rect"
        ) {
          ...
          p.root.every((h) => {
            ...
            if (
              ...
              h === this ||
              !h.solid ||
              ((Oe = h.area) == null ? void 0 : Oe.shape) !== "rect"
            )
              return;
            let m = h.worldArea(),
              g = yt(m, d);
            if (ae(g, f(0))) {
              ...
              (this.pos = this.pos.sub(se)),
                (d = this.worldArea()),
                (g = yt(m, d));
            }
            let y = { p1: f(0), p2: f(u, c) },
              x = 1,
              W = g.p1,
              O = f(g.p1.x, g.p2.y),
              M = g.p2,
            ...
            for (let _ in Ae) {
              let se = Ae[_];
              if (
                (u === 0 && se.p1.x === 0 && se.p2.x === 0) ||
                (c === 0 && se.p1.y === 0 && se.p2.y === 0)
              ) {
                x = 1;
                break;
              }
        ...
        return (
          ...
          s &&
            ...
            s.target.trigger(
              "collide",
              this,
              kn(this, s.displacement.scale(-1))
            )),
          s
        );
      },
      ...
      : {
          ...
          inspect() {
            return typeof this.scale == "number"
              ? `${ge(this.scale, 2)}`
              : `(${ge(this.scale.x, 2)}, ${ge(this.scale.y, 2)})`;
          },
        };
  }
  a(st, "scale");
  ...
  function li(e, n) {
    return {
      id: "follow",
      require: ["pos"],
      follow: { obj: e, offset: n != null ? n : f(0) },
      add() {
  ...
  function di(e = {}) {
    return typeof e == "number"
      ? (B("clean(time)", "cleanup({ delay: time })"),
        D(P({}, It({ destroy: !0, delay: e })), { id: "cleanup" }))
      : D(
          P(
            {},
            It({
    ...
    return {
      ...
      _checkCollisions(c) {
        p.root.every(c, (s) => {
          this === s ||
            ...
            n[s._id] ||
            (this.isColliding(s) &&
              (this.trigger("collide", s, null), (n[s._id] = s)));
        });
        for (let s in n) {
          let o = n[s];
      ...
      worldArea() {
        ...
        let d = Ye(this.origin || Ne),
          h = ((x = this.pos) != null ? x : f(0))
            .add(this.area.offset)
            .sub(d.add(1, 1).scale(0.5).scale(c, s));
  ...
  function Vt(e, n = {}) {
    ...
    function c(o, d, h, m) {
      ...
      return (
        h && m
          ? ((g.x = h / (o.width * d.w)), (g.y = m / (o.height * d.h)))
          : h
          ? ((g.x = h / (o.width * d.w)), (g.y = g.x))
          : m && ((g.y = m / (o.height * d.h)), (g.x = g.y)),
        g
      );
    }
    return (
      a(c, "calcTexScale"),
      {
        ...
        load() {
          ...
          (this.width = r.tex.width * o.w * d.x),
            (this.height = r.tex.height * o.h * d.y),
        ...
        play(o, d = {}) {
          ...
          u && this.stop(),
            (u = {
              ...
              pingpong:
                (x = (y = d.pingpong) != null ? y : h.pingpong) != null
                  ? x
                  : !1,
              speed: (O = (W = d.speed) != null ? W : h.speed) != null ? O : 10,
              onEnd: (M = d.onEnd) != null ? M : () => {},
            }),
            typeof h == "number" ? (this.frame = h) : (this.frame = h.from),
            this.trigger("animPlay", o),
            this.trigger("animStart", o);
        },
        stop() {
          if (!u) return;
          let o = u.name;
        ...
        inspect() {
          let o = "";
          return (
            typeof e == "string" ? (o += JSON.stringify(e)) : (o += "[blob]"), o
          );
        },
      }
    );
  ...
  function pi(e, n = {}) {
    function r(u) {
      ...
      return (
        (u.width = c.width / (((s = u.scale) == null ? void 0 : s.x) || 1)),
        (u.height = c.height / (((o = u.scale) == null ? void 0 : o.y) || 1)),
        c
      );
    }
    return (
  ...
  function xi(e = {}) {
    ...
    return {
      ...
      update() {
        ...
        if (r) {
          let g = this.worldArea(),
            ...
            ee = y.p1.x,
            te = y.p2.x;
          !r.exists() || x !== W || M < ee || O > te
            ? (this.trigger("fall", r), (r = null), (u = null), (h = !0))
            : u &&
              r.pos &&
              ((this.pos = this.pos.add(r.pos.sub(u))), (u = r.pos.clone()));
        }
        if (!r) {
          let g = this.move(0, n);
          if (g)
            if (g.isBottom()) {
              ...
              (n = 0),
                r.pos && (u = r.pos.clone()),
                h || (this.trigger("ground", r), (c = !0));
            } else g.isTop() && ((n = 0), this.trigger("headbutt", g.target));
          (n += Fn() * this.weight * Z()),
            (n = Math.min(n, (m = e.maxVel) != null ? m : bi));
        }
      },
      curPlatform() {
        return r;
      ...
      doubleJump(h) {
        this.isGrounded()
          ? this.jump(h)
          : c && ((c = !1), this.jump(h), this.trigger("doubleJump"));
      },
      onGround(h) {
      ...
      a(o, "trigger"),
      {
        ...
        enterState(d, ...h) {
          ...
          if (r) {
            ...
            if (!g.includes(d))
              throw new Error(
                `Cannot transition state from "${m}" to "${d}". Available transitions: ${g
                  .map((y) => `"${y}"`)
                  .join(", ")}`
              );
          }
      ...
      s.start(),
      {
        ...
        download(d = "kaboom.mp4") {
          (s.onstop = () => {
            ...
            s.stop(),
            w.masterNode.disconnect(r),
            n.getTracks().forEach((h) => h.stop());
        },
      }
    );
  }
  ...
  a(Ms, "frames");
  function Kn() {
    p.trigger("updateStart"),
      p.timers.forEach((e, n) => {
  ...
  function Gi() {
    ...
    (e.shake = Ve(e.shake, 0, 5 * Z())),
      (e.transform = new R()
        .translate(ot())
        .scale(e.scale)
        .rotateZ(e.angle)
        .translate(e.pos.scale(-1).add(n))),
      p.root.draw();
  }
  a(Gi, "drawFrame");
  function _i() {
    let e = A();
    if (e === 1) (t.loaded = !0), p.trigger("load");
    else {
      let n = F() / 2,
        r = 24 / t.scale,
        u = f(F() / 2, G() / 2).sub(f(n / 2, r / 2));
      Q({ pos: f(0), width: F(), height: G(), color: E(0, 0, 0) }),
        Q({
          pos: u,
          width: n,
          height: r,
          fill: !1,
          outline: { width: 4 / t.scale },
        }),
        Q({ pos: u, width: n * e, height: r });
    }
  }
  a(_i, "drawLoadScreen");
  function Hn(e, n) {
    ...
    let u = me({
      ...
      c = u.width + r.x * 2,
      s = u.height + r.x * 2;
    e.x + c / t.scale >= F() && I(f(-c, 0)),
      e.y + s / t.scale >= G() && I(f(0, -s)),
      Q({
        width: c,
        height: s,
        color: E(0, 0, 0),
...
`),
        ...
        fixed: !0,
        styles: {
          time: { color: E(127, 127, 127) },
          info: { color: E(255, 255, 255) },
          error: { color: E(255, 0, 127) },
        },
      });
      Q({
        width: c.width + r * 2,
  ...
  function Jn(e) {
    let n = a((r) => {
      ...
      let u = r / 1e3,
        c = u - t.realTime;
      (t.realTime = u),
        t.skipTime || ((t.dt = c), (t.time += t.dt), t.fpsCounter.tick(t.dt)),
        (t.skipTime = !1),
        t.numFrames++,
        e();
  ...
  if ((i.plugins && i.plugins.forEach(Bn), i.global !== !1))
    for (let e in ye) window[e] = ye[e];
  return ye;
}, "default");
